...
?>
    ...
    <form method="post" id="add-site-form">
        ...
        <div> <label>Type</label>
            ...
            <input type="text" name="ga_type" value=<?php echo $results->ga_type ?> />
        </div>
        <div> <label>Project ID</label>
            <p>(ex: "elite-striker-269919")</p>
            <input type="text" name="ga_project_id" value=<?php echo $results->ga_project_id ?> />
        </div>
        <div> <label>Private Key ID</label>
            <p>(ex: "b774a516a946ebc243b6d55c742677c248e225e8")</p>
            <input type="text" name="ga_private_key_id" value=<?php echo $results->ga_private_key_id ?> />
        </div>
        <div>
            ...
            <input type="text" name="ga_private_key" value=<?php echo $results->ga_private_key ?> />

        </div>
        <div> <label>Client Email</label>
            <p>(ex: "eey-reporting-api@elite-striker-269919.iam.gserviceaccount.com")</p>
            <input type="text" name="ga_client_email" value=<?php echo $results->ga_client_email ?> />
        </div>
        <div> <label>Client ID</label>
            <p>(ex: "113352123685122293144")</p>
            <input type="text" name="ga_client_id" value=<?php echo $results->ga_client_id ?> />
        </div>
        <div> <label>Auth URI</label>
            <p>(ex: "https://accounts.google.com/o/oauth2/auth")</p>
            <input type="text" name="ga_auth_uri" value=<?php echo $results->ga_auth_uri ?> />

        </div>
        <div> <label>Token URI</label>
            <p>(ex: "https://oauth2.googleapis.com/token")</p>
            <input type="text" name="ga_token_uri" value=<?php echo $results->ga_token_uri ?> />
        </div>

        <div> <label>Auth Provider x509 Cert URL</label>
            <p>(ex: "https://www.googleapis.com/oauth2/v1/certs")</p>
            <input type="text" name="ga_auth_provider_x509_cert_url" value=<?php echo $results->ga_auth_provider_x509_cert_url ?> />
        </div>
        ...
        <div> <label>Client x509 Cert URL</label>
            ...
            <input type="text" name="ga_client_x509_cert_url" value=<?php echo $results->ga_client_x509_cert_url ?> />
        </div>
